...
let ayurveda = document.getElementById("container");

let generateAyurveda = () => {
    return (ayurveda.innerHTML = ayurvedaItems.map((x) => {
        return `<a href="">
...
let singleProductPage = (id) => {
    let selectedItem = id;
    let search = ayurvedaItems.find((x) => x.id === selectedItem);
